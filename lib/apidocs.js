...
function apijsonRoute() {
        ...
        if(doc_fr)
          {
            ...
            apiToAdd.name = doc_fr.api_doc.body.info.title;
            apiToAdd.description = doc_fr.api_doc.body.info.description;
  ...
  {
    onsole.log(new Date(), 'checking for this name  ' + system_name );
