        ...
        if(doc_fr)
          {
            ...
            console.log("this is the body " + JSON.stringify(swaggerbody));
            apiToAdd.name = swaggerbody.swagger.info.title;
            console.log("This is the name " + apiToAdd.name);
            //apiToAdd.description = doc_fr.api_doc.body.swagger.info.description;
