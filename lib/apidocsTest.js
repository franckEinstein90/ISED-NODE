...
function apijsonRoute() {
            ...
            return new Promise(function(resolve, reject) {
                rp.get(url)
                	...
                	var jsonObj = JSON.parse(jsonresp);
                        ...
                        console.log("these are the plans " + jsonObj.account.plans.plan )
    ...
    const validateUserByPlans = function(tenant, cb) {
        ...
        return new Promise(function(resolve, reject) {
                ...
                return new Promise(function(resolve, reject) {
                    rp.get(url, {
                        ...
                        .then(function(response) {
                           ...
                           console.log("This is the feature data " + featureData);
            ...
            if (tenant.plansforUser && Array.isArray(tenant.plansforUser)) {
                            ...
                            if (add) {
                                ...
                                for (var doc of tenant.docs.api_docs) {
                                    if (doc.api_doc.system_name === api.service.system_name + '-' + lang && doc.api_doc.published === true) {
                                        ...
                                        console.log("key in api docs " +    tenant.name +'-'+ api.service.id +'-'+ lang );
                                        if(cache.get(tenant.name +'-'+ api.service.id +'-'+ lang) == null)
                                        {
                                            console.log("adding this to the cache " + tenant.name +'-'+ api.service.id +'-'+ lang );
