...
function apijsonRoute() {
        ...
        if (!email) {
            ...
            async.each(validTenants, function(tenant, callback) {
                ...
                docsPromise.then(function(payload) {
                    ...
                    getAPISByTenant_(tenant,tenantToAdd);
              ...
              /*      apiPromise.then(function(payload) {
                ...
                }).then(function(){ pushToMasterTenant(tenants, tenantToAdd);
     ...
     * get the api(s) tied to a tenant
     */
    function getAPISByTenant_(tenant, tenantToAdd) {
        	...
        	doOther(JSON.parse(body).services,tenant,tenantToAdd);
    ...
    function doOther(apis,tenant,tenantToAdd)
    {
