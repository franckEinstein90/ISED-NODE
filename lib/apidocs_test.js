...
function apijsonRoute() {
        ...
        if (!email) {
            ...
            async.each(validTenants, function(tenant, callback) {
                ...
                docsPromise.then(function(payload) {
                    ...
                    tenantToAdd.apis = getAPISByTenant_(tenant);
    ...
    function doOther(apis,tenant)
    {
	 var eligible  = [];
	  ...
	  async.each(validTenants, function(api, callback) {
		  ...
		  callback();
	                ...
	                if (err) {
	                    // One of the iterations produced an error.
	                    // All processing will now stop.
	                    console.log('Failed to add api..bailing out');
	                } else {


	                    console.log("This is the eligible size " +eligible.length );
	            	return eligible;
	                }
	            })
