...
function threescaleRoute() {
  ...
  var getAPIs =  function(tid)
  {
    ...
    console.log("harpreet watch out " + tenant);
    // curl -v  -X GET "https://ised-admin.df24.ised-dev.openshiftapps.com/admin/api/services.xml?access_token=57a3f29bd0f5f9fd9ab0ebd61fad90ad899d8c1367996f09485d0e784bad8457"
    var url = 'https://' + tenant.admin_domain + '/admin/api/services?access_token=' + tenant.access_token;
    request.get ({
      url: url
    }, function (error, response, body){

      console.log("harpreet ..watch out " + JSON.parse(body));
