...
function threescaleRoute() {
  ...
  threescale.get('/tenants', function (req, res){
    ...
    filteredArray.forEach ( function (item, index, array){
       console.log("before" + item.apis);
       item.apis = getAPIs(item.id);
       console.log("after " + item.apis.list);
    });
  ...
  var getAPIs =  function(tid)
  {
    ...
    console.log("harpreet watch out " + tenant.admin_domain);
    ...
    request.get ({
      ...
      console.log("harpreet ..watch out..this is the response " + body);
      apis.list =  body;   
    }); 
