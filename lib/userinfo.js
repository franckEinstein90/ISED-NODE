                ...
                if (JSON.parse(payLoad).status) {
                	...
                	for (var i = 0; i < arrayLength; i++) {
                	    var newLink = {};
                    	    ...
                    	    newLink.href = "https://" + tenant.name + ".beta.api.canada.ca/admin/applications/" +  apps.applications[i].application.id + "?lang=en";
                    	/*    console.log(newLink);
                    	    ...
                    	    var cachedApiName =  memCache.get(tenant.name +'-'+ apps.applications[i].application.service_id +'-'+ lang);
                    	    if(cachedApiName)
                    	    {
