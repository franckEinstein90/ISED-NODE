        ...
        async.each(validTenants, function(tenant, callback) {
            ...
            idPromise.then(function(payLoad) {
                if (JSON.parse(payLoad).status) {
                	...
                	console.log("length hai bhai" + apps.applications.length);
                	...
                	for (var i = 0; i < arrayLength; i++) {
                	    var newLink = {};
                    	    ...
                    	    newLink.href = "https://" + tenant.name + ".beta.api.canada.ca/admin/applications/" +  apps.applications[i].id + "?lang=en";
                    	    console.log("link hai bhai " +  newLink);
                    	    //apps.applications[i].links.push(newLink);
                	 }
