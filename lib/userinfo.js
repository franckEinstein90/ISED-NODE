...
function  userinfoRoute() {
    ...
    userinfo.get('/userinfo.json', function(req, res) {
        ...
        async.each(validTenants, function(tenant, callback) {
            ...
            // if any of the  tenant additions lead to an error....not happening in our case but
            if (err) {
    ...
    /**
     * making sure we push unique tenants...probably don't need it since there are no bad global var...
     */
